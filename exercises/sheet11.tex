...
\footnotetext{Falls Sie Verständnisprobleme haben, was if-Konstrukte sind und was sie bedeuten (als Nichtinformatiker), kontaktieren Sie den Tutor oder Dozenten!}
\end{exercise}
