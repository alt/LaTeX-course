...
\author{Arno Trautmann\\[-1ex] \normalsize \url{arno.trautmann@gmx.de}}
\date{}
...
\newpage
\section{Kursinhalt}
Grundsätzlich wird sich der Kurs in drei Teile gliedern, die sich oft überschneiden werden und nicht strikt getrennt werden können:
\catcode`\•13
\let•\item
\begin{enumerate}
...
\footnote{
  \marginnote{\vspace*{-2cm}\\ \hspace*{-1.5cm}\includegraphics[height=2cm]{ctanlion}\\ \parbox{3cm}{\hspace*{-1.5cm}der CTAN-Löwe}}
