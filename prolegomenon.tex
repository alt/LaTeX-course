...
Eigentlich kann dieser Abschnitt den ganzen Kurs ersetzen – denn \LaTeX\ gehört zu den bestdokumentierten Systemen überhaupt. Leider sind viele Anleitungen, vor allem für Anfänger, häufig veraltet, unvollständig oder setzen andere Schwerpunkte als in diesem Kurs. Viele Bücher verschweigen etwa die Existenz von \XeTeX\ und \luaTeX völlig, da es sehr neue Systeme sind und die Bücher vor deren Aufkommen verfasst wurden. Auch gibt es für \ConTeXt\ leider kein Referenzbuch. Eine kurze Literaturliste mit persönlichen Empfehlungen findet sich im Moodle.
