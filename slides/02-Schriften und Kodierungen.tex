...
\begin{frame}[plain]
\kern-1cm \hfill Bild von Gutenberg? \hfill \includegraphics[height=\paperheight+50pt]{Gutenberg}\hfill\hfill
\end{frame}
...
\frame[plain]{Unicode}%\includegraphics[width=1\textwidth]{unicode}}
